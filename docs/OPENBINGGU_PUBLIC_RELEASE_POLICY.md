...
> 참조: [OPENBINGGU_PUBLIC_RELEASE_CHECKLIST.md](OPENBINGGU_PUBLIC_RELEASE_CHECKLIST.md) · [OPENBINGGU_COMMON_BUS.md](OPENBINGGU_COMMON_BUS.md) · [OPENBINGGU_EVALUATION_PROTOCOL.md](OPENBINGGU_EVALUATION_PROTOCOL.md)
